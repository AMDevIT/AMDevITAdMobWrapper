...
typedef SWIFT_ENUM(NSInteger, BannerAdViewSize, open) {
  BannerAdViewSizeAdaptive = 0,
  BannerAdViewSizeBanner = 1,
  BannerAdViewSizeLargeBanner = 2,
  BannerAdViewSizeMediumRectangle = 3,
  BannerAdViewSizeFullBanner = 4,
  BannerAdViewSizeLeaderboard = 5,
};
...
- (void)onAdClicked;
- (void)onAdImpression;
- (void)onAdFailedToShowWithErrorCode:(NSInteger)errorCode errorMessage:(NSString * _Nonnull)errorMessage;
@end
...
- (void)onRewardEarnedWithType:(NSString * _Nonnull)type amount:(NSInteger)amount;
@end
