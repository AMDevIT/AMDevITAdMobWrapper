...
#ifndef ADMOBWRAPPER_SWIFT_H
#define ADMOBWRAPPER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AdMobWrapper",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface AppOpenAdWrapper (SWIFT_EXTENSION(AdMobWrapper)) <GADFullScreenContentDelegate>
...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (GADBannerView * _Nonnull)loadWithAdUnitId:(NSString * _Nonnull)adUnitId viewController:(UIViewController * _Nonnull)viewController loadListener:(id <OnAdLoadedListener> _Nonnull)loadListener eventListener:(id <OnAdEventListener> _Nullable)eventListener SWIFT_WARN_UNUSED_RESULT;
- (void)destroy;
@end

@interface BannerAdWrapper (SWIFT_EXTENSION(AdMobWrapper)) <GADBannerViewDelegate>
...
@interface InterstitialAdWrapper (SWIFT_EXTENSION(AdMobWrapper)) <GADFullScreenContentDelegate>
- (void)adDidRecordImpression:(id <GADFullScreenPresentingAd> _Nonnull)ad;
- (void)adDidRecordClick:(id <GADFullScreenPresentingAd> _Nonnull)ad;
- (void)adWillPresentFullScreenContent:(id <GADFullScreenPresentingAd> _Nonnull)ad;
- (void)adWillDismissFullScreenContent:(id <GADFullScreenPresentingAd> _Nonnull)ad;
...
- (void)onAdClicked;
- (void)onAdImpression;
- (void)onAdFailedToShowWithErrorCode:(int32_t)errorCode errorMessage:(NSString * _Nonnull)errorMessage;
@end

SWIFT_PROTOCOL("_TtP12AdMobWrapper18OnAdLoadedListener_")
@protocol OnAdLoadedListener
- (void)onAdLoaded;
- (void)onAdFailedToLoadWithErrorCode:(int32_t)errorCode errorMessage:(NSString * _Nonnull)errorMessage;
@end

SWIFT_PROTOCOL("_TtP12AdMobWrapper21OnInitializedListener_")
@protocol OnInitializedListener
- (void)onInitialized;
- (void)onInitializationFailedWithError:(NSString * _Nonnull)error;
@end

SWIFT_PROTOCOL("_TtP12AdMobWrapper22OnRewardEarnedListener_")
@protocol OnRewardEarnedListener
- (void)onRewardEarnedWithType:(NSString * _Nonnull)type amount:(int32_t)amount;
@end
...
@interface RewardedAdWrapper (SWIFT_EXTENSION(AdMobWrapper)) <GADFullScreenContentDelegate>
- (void)adDidRecordImpression:(id <GADFullScreenPresentingAd> _Nonnull)ad;
- (void)adDidRecordClick:(id <GADFullScreenPresentingAd> _Nonnull)ad;
- (void)adWillPresentFullScreenContent:(id <GADFullScreenPresentingAd> _Nonnull)ad;
- (void)adWillDismissFullScreenContent:(id <GADFullScreenPresentingAd> _Nonnull)ad;
