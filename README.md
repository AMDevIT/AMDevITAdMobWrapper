...
|---|---|---|
| `AMDevIT.Admob.Wrapper.Android` | .NET binding for the native Kotlin AAR | [![NuGet](https://img.shields.io/nuget/v/AMDevIT.Admob.Wrapper.Droid)](https://www.nuget.org/packages/AMDevIT.Admob.Wrapper.Droid) |
| `AMDevIT.Admob.Wrapper.iOS` | .NET binding for the native Swift xcframework | [![NuGet](https://img.shields.io/nuget/v/AMDevIT.Admob.Wrapper.iOSNative)](https://www.nuget.org/packages/AMDevIT.Admob.Wrapper.iOSNative) |
